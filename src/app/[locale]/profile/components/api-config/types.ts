...
export const PRESET_MODELS: PresetModel[] = [
    ...
    // KIE 视频模型
    { modelId: 'grok-imagine/image-to-video', name: 'Grok Imagine I2V', type: 'video', provider: 'kie' },
    { modelId: 'grok-imagine/text-to-video', name: 'Grok Imagine T2V', type: 'video', provider: 'kie' },
    ...
    { modelId: 'kling/kling-3-0', name: 'Kling 3.0', type: 'video', provider: 'kie' },
    ...
    { modelId: 'hailuo/2-3-image-to-video-standard', name: 'Hailuo 2.3 Std I2V', type: 'video', provider: 'kie' },
